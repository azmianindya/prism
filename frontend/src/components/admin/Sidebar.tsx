...
const menus = [
    ...
    { icon: <FaRegCircleCheck />, label: 'Validasi Absensi', path: '/validasi' },
    { icon: <TbMapSearch />, label: 'Monitoring Area', path: '/monitoring' },
    { icon: <BsPersonVcardFill/>, label: 'Data Mahasiswa', path: '/area' },
]
